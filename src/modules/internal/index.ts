...
import { createHomeMediaBannerController } from "./controllers/createHomeMediaBanner.controller";
...
export const internalModule = new Elysia({
  ...
  .post("/home-media-banner/add", createHomeMediaBannerController, createHomeMediaBannerSchema);
